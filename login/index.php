...
if(isset($_POST['submit'])){
  ...
  if(!$error){
    ...
    if($getActivatedState == 0){
      # not verified
      $error = true;
  		$activatedMessage = "Dein Account ist nicht verifiziert! Eine Anleitung gibt es <a href='https://github.com/LegendSkyFall/vkba/wiki/Account-verifizieren'>hier</a>. Bitte anschließend <a href='../verify'>hier</a> Deinen Account aktivieren</a>.";
  	}
  ...
  if(!$error){
    if(empty($_SESSION["user"])){
      ...
      $errorMessage = "Zugangsdaten falsch oder Account nicht verifiziert (Anleitung gibt es <a href='https://github.com/LegendSkyFall/vkba/wiki/Account-verifizieren'>hier</a>).Bitte erneut versuchen! Unter Umständen kann auch eine Sperrung des Accounts vorliegen.";
	  	session_destroy();
  }
}
?>
